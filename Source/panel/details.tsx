...
export class Details extends Component<DetailsProps> {
	...
	render() {
		...
		return (
			<div className="svDetailsPane" style={{ height: height.get() }}>
				{result && (
						...
						<Tab name="Info">
							<div className="svDetailsBody svDetailsInfo">
								...
								<div className="svDetailsGrid">
									...
									<span>Locations</span>{" "}
									<span className="svDetailsGridLocations">
									...
									const renderThreadFlowLocation = (
										...
										return (
											<>
												...
												<div className="svSecondary">
													{uri?.file ?? "—"}
												</div>
												<div className="svLineNum">
													{region?.startLine}:
