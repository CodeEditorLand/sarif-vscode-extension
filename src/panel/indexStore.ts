...
import type { Log, PhysicalLocation, ReportingDescriptor, Result } from "sarif";
import {
	type CommandExtensionToPanel,
	type Visibility,
	augmentLog,
	filtersColumn,
	filtersRow,
...
import { type Row, RowItem } from "./tableStore";
...
export class IndexStore {
	...
	constructor(
		state: Record<string, Record<string, Record<string, Visibility>>>,
		workspaceUri?: string,
...
export async function postSelectArtifact(
	result: Result,
